<x-layout>
    ...
    <form action="/job/{{$job->id}}/update" method="POST">
        @csrf
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <form action="/job/{{$job->id}}/delete" method="POST" class="flex items-center">
                @csrf
                <button type="submit" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm
